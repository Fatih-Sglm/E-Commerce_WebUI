...
import { AlertifyService, MessageType, Position } from 'src/app/services/common/notification/alertify.service';
...
export class LoginComponent extends BaseComponent implements OnInit {
  constructor(private userAuthService: UserAuthService, spinner: NgxSpinnerService
    ...
    private authService: AuthService ,private router: Router ) { super(spinner) }
